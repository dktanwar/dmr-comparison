...
# Packages required
```{r 20181125-generate-input-datasets-1, message=F, warning=F}
library(data.table)
```
...
## Negative control
```{r 20181125-generate-input-datasets-2}
...
## Simulated data
```{r 20181125-generate-input-datasets-3}
# Files from 6 replicates
...
## Bismark `cov`
```{r 20181125-generate-input-datasets-4}
...
### Save data
```{r 20181125-generate-input-datasets-5}
...
## Methpipe inputs
```{r 20181125-generate-input-datasets-6}
...
### Save data
```{r 20181125-generate-input-datasets-7}
...
## CGmapTools inputs
```{r 20181125-generate-input-datasets-8}
...
### Save data
```{r 20181125-generate-input-datasets-9}
...
## DMRcaller inputs
```{r 20181125-generate-input-datasets-10}
...
### Save data
```{r 20181125-generate-input-datasets-11}
...
## Negative control
```{r 20181125-generate-input-datasets-12, warning=F}
...
## Simulated data
```{r 20181125-generate-input-datasets-13, warning=F}
# Make one dataframe fromlist of files
...
```{r 20181125-generate-input-datasets-14}
...
<details>
```{r 20181125-generate-input-datasets-15}
