...
2. **Noise filter:** A smoothing kernel is applied on the data before calling differentially methylated loci. Four kernels are available: uniform, triangular, Gaussian, and Epanechnicov.
...
```{r}
dmr.ls.nc <- dmrcaller_analysis(grp1 = mData.grp1.nc, grp2 = mData.grp2.nc, 
...
```{r}
dmr.ls.sim <- dmrcaller_analysis(grp1 = mData.grp1.sim, grp2 = mData.grp2.sim, 
                                methods = "all", kernals = "all",
                                keyword = "sim_data")
```
