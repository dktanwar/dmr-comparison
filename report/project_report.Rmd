...
In total 7 different methods were used for the comparison. Their main features, as well as links to the analysis files are summarized in the following table:
...
We have also checked how well the methods control FDR (figure ...). For this, we plotted the observed FDR (the proportion of false discoveries) and the specified FDR (cutoff after multiple testing correction by BH). We can see that dmrseq again outperforms the other methods.
 ...
 More comparison plots as well as the code can be found [here](../exp/20181221-plot_results-03/20190108-04_comparison_plots/comparison_plots.html).
